  ...
  return (
    <div className="min-h-screen flex w-full bg-slate-50">
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <form className="mt-10 space-y-6" onSubmit={handleLogin}>
            <div className="space-y-5">
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  className="h-14 rounded-xl bg-white border-slate-200 focus:border-primary-gold focus:ring-primary-gold text-base shadow-sm"
                  required 
                />
              </div>
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <a href="#" className="text-sm font-bold text-primary-gold hover:text-primary-gold transition-colors">Mot de passe oublié ?</a>
                </div>
                <div className="relative">
                  <Input 
                  type={showPassword ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} 
                  placeholder="••••••••" 
                  className="h-14 rounded-xl bg-white border-slate-200 focus:border-primary-gold focus:ring-primary-gold text-base shadow-sm pr-12"
                  required 
                />
            ...
            <div className="flex items-center">
              <input id="remember-me" name="remember-me" type="checkbox" className="h-4 w-4 rounded border-slate-300 text-primary-gold focus:ring-primary-gold" />
              <label htmlFor="remember-me" className="ml-2 block text-sm font-medium text-slate-600">Rester connecté</label>
            </div>

            <div>
              <Button type="submit" disabled={isLoading} className="w-full h-14 bg-primary-gold hover:bg-primary-gold/90 text-white rounded-xl text-lg font-bold shadow-xl shadow-primary-gold/20 transition-all hover:-translate-y-1 group">
          ...
          <div className="text-center text-sm font-medium text-slate-500 mt-10">
            ...
            <Link to="/register" className="font-bold text-primary-gold hover:text-primary-gold transition-colors">
      ...
      <div className="hidden lg:flex lg:flex-col flex-1 relative bg-slate-900 overflow-hidden p-12">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-slate-900 to-slate-950 opacity-90"></div>
        ...
        <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-slate-700 rounded-full mix-blend-screen filter blur-[150px] opacity-10 translate-y-1/3 -translate-x-1/3"></div>
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center max-w-2xl mx-auto w-full">
           <div className="bg-white/10 backdrop-blur-xl border border-white/10 p-10 rounded-3xl shadow-2xl">
              <div className="w-14 h-14 bg-primary-gold rounded-2xl flex items-center justify-center mb-8 shadow-lg shadow-primary-gold/30 text-white">
              ...
              <div className="space-y-6">
                 <div className="flex items-center gap-4 text-white">
                    <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center shrink-0 border border-white/5">
                       <PlaneTakeoff className="w-5 h-5 text-primary-gold/70" />
                    </div>
                    <div>
                 ...
                 <div className="flex items-center gap-4 text-white">
                    <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center shrink-0 border border-white/5">
                       <ShieldCheck className="w-5 h-5 text-primary-gold/70" />
                    </div>
                    <div>
                 ...
                 <div className="flex items-center gap-4 text-white">
                    <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center shrink-0 border border-white/5">
                       <Building2 className="w-5 h-5 text-primary-gold/70" />
                    </div>
                    <div>
