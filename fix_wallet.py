...
with open('components/agency/AgencyWallet.tsx', 'r') as f:
    content = f.read()

# Make sure we import FileText, Check, X
if 'FileText' not in content:
    content = content.replace('Clock } from "lucide-react";', 'Clock, FileText, Check, X } from "lucide-react";')

new_wallet = """import { useState } from "react";
...
with open('components/agency/AgencyWallet.tsx', 'w') as f:
    f.write(new_wallet)
