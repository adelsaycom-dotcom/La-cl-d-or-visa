                  ...
                  {notificationsCount > 0 && (
                    <div className="p-2 border-t bg-gray-50">
                      <button 
                        ...
                        onClick={() => markAllNotificationsAsRead("current-user-agencyId")}
                      >
...
# Using regex to replace the dropdown menu
content = re.sub(r'\{/\* Notifications \*/\}.*?</DropdownMenu>', new_dropdown, content, flags=re.DOTALL)
